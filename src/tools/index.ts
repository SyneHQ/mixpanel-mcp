...
export function registerTools(server: McpServer, args: string[]) {
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        const url = `https://mixpanel.com/api/query/events/top?project_id=${project_id}&type=${type}${
          limit ? `&limit=${limit}` : ""
        }`;
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct URL with query parameters
        let url = `https://mixpanel.com/api/query/stream/query?project_id=${project_id}&distinct_ids=${encodeURIComponent(
          distinct_ids
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct URL with query parameters
        const url = `https://mixpanel.com/api/query/events/names?project_id=${project_id}&type=${type}${
          limit ? `&limit=${limit}` : ""
        }`;
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        if (workspace_id) queryParams.append("workspace_id", workspace_id);
        if (retention_type)
          queryParams.append("retention_type", retention_type);
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct base URL with required parameters
        let url = `https://mixpanel.com/api/query/segmentation?project_id=${project_id}&event=${encodeURIComponent(
          event
        )}&from_date=${from_date}&to_date=${to_date}`;
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct base URL with required parameters
        let url = `https://mixpanel.com/api/query/segmentation/numeric?project_id=${project_id}&event=${encodeURIComponent(
          event
        )}&from_date=${from_date}&to_date=${to_date}&on=${encodeURIComponent(
          on
        )}`;
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct base URL with required parameters
        let url = `https://mixpanel.com/api/query/segmentation/average?project_id=${project_id}&event=${encodeURIComponent(
          event
        )}&from_date=${from_date}&to_date=${to_date}&on=${encodeURIComponent(
          on
        )}`;
  ...
  server.tool(
    ...
    async ({ project_id = DEFAULT_PROJECT_ID, workspace_id, event, limit }) => {
      try {
        ...
        // Construct base URL with required parameters
        let url = `https://mixpanel.com/api/query/events/properties/top?project_id=${project_id}&event=${encodeURIComponent(
          event
        )}`;
  ...
  server.tool(
    ...
    async ({
      ...
      try {
        ...
        // Construct base URL with required parameters
        let url = `https://mixpanel.com/api/query/events/properties/values?project_id=${project_id}&event=${encodeURIComponent(
          event
